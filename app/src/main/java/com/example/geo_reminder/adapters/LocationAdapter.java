package com.example.geo_reminder.adapters;
...
public class LocationAdapter extends RecyclerView.Adapter<LocationAdapter.Holder> {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int i) {
            ...
            public void onClick(View v) {
                ...
                btnAdd.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        UpdateTaskBLL bll = new UpdateTaskBLL(longLat1, longLat.get_id(), Url.cookie);
                        if(bll.updateTask()){
        ...
        holder.iDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Url.getEndPoints().deletelonglat(Url.cookie, longLat.get_id());
                StrictMod.StrictMode();
                DeleteTaskBLL bll = null;
                bll = new DeleteTaskBLL(longLat, longLat.get_id(), Url.cookie);
                if (bll.deleteTask()) {
